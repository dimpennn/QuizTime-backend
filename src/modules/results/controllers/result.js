...
export const getUserResults = async (request, reply) => {
	...
	const data = await resultService.getResults({ userId, limit, skip, search, sort });
...
export const saveResult = async (request, reply) => {
	...
	const data = await resultService.saveResult({ userId, quizId, answers, summary, timestamp });
